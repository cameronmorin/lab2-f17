...
80100cd1:	8b 77 04             	mov    0x4(%edi),%esi
  curproc->stackSize = 1;                                             //ADDED LAB3
...
8010385c:	0f 84 c4 00 00 00    	je     80103926 <fork+0xe6>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz, curproc->stackSize)) == 0){                  //ADDED LAB3
...
8010457e:	78 20                	js     801045a0 <argptr+0x40>
    return -1;
  if(size < 0 || (uint)i >= USERSTACKBASE || (uint)i+size > USERSTACKBASE)         //ADDED LAB3
