...
int main(int argc, char** argv) {
    ...
    1010:	e8 0b 00 00 00       	call   1020 <fib>

    exit();
    1015:	e8 88 02 00 00       	call   12a2 <exit>
...
int fib(int n) {
    ...
    1023:	56                   	push   %esi
    1024:	53                   	push   %ebx
    1025:	83 ec 10             	sub    $0x10,%esp
    1028:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if (n == 0) return 0;
    102b:	85 db                	test   %ebx,%ebx
    102d:	74 35                	je     1064 <fib+0x44>
    if (n == 1) return 1;
    102f:	83 fb 01             	cmp    $0x1,%ebx
    1032:	74 34                	je     1068 <fib+0x48>
    1034:	31 f6                	xor    %esi,%esi
    1036:	eb 05                	jmp    103d <fib+0x1d>
    1038:	83 fb 01             	cmp    $0x1,%ebx
    103b:	74 1b                	je     1058 <fib+0x38>
    103d:	8d 43 ff             	lea    -0x1(%ebx),%eax

    return fib(n-1) + fib(n-2);
    1040:	89 04 24             	mov    %eax,(%esp)
    1043:	e8 d8 ff ff ff       	call   1020 <fib>
    1048:	01 c6                	add    %eax,%esi
    if (n == 0) return 0;
    104a:	83 eb 02             	sub    $0x2,%ebx
    104d:	75 e9                	jne    1038 <fib+0x18>
}
    ...
    1066:	eb e7                	jmp    104f <fib+0x2f>
    if (n == 1) return 1;
    1068:	be 01 00 00 00       	mov    $0x1,%esi
    106d:	eb e0                	jmp    104f <fib+0x2f>
    106f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1399:	0f b6 92 a8 17 00 00 	movzbl 0x17a8(%edx),%edx
  }while((x /= base) != 0);
    ...
    140e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    152f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    1531:	b8 a1 17 00 00       	mov    $0x17a1,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15f1:	a1 b8 1a 00 00       	mov    0x1ab8,%eax
{
  ...
  freep = p;
    1639:	a3 b8 1a 00 00       	mov    %eax,0x1ab8
}
    163e:	5b                   	pop    %ebx
    163f:	5e                   	pop    %esi
    1640:	5f                   	pop    %edi
  ...
  freep = p;
    1662:	a3 b8 1a 00 00       	mov    %eax,0x1ab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    168c:	8b 1d b8 1a 00 00    	mov    0x1ab8,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16cb:	3b 15 b8 1a 00 00    	cmp    0x1ab8,%edx
  ...
  return freep;
    1702:	8b 15 b8 1a 00 00    	mov    0x1ab8,%edx
    ...
    1724:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    1727:	89 15 b8 1a 00 00    	mov    %edx,0x1ab8
      return (void*)(p + 1);
    ...
    base.s.ptr = freep = prevp = &base;
    173e:	c7 05 b8 1a 00 00 bc 	movl   $0x1abc,0x1ab8
    1745:	1a 00 00 
    base.s.size = 0;
    1748:	ba bc 1a 00 00       	mov    $0x1abc,%edx
    base.s.ptr = freep = prevp = &base;
    174d:	c7 05 bc 1a 00 00 bc 	movl   $0x1abc,0x1abc
    1754:	1a 00 00 
    base.s.size = 0;
    1757:	c7 05 c0 1a 00 00 00 	movl   $0x0,0x1ac0
    175e:	00 00 00 
